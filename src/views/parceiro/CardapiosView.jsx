...
export default function CardapiosView() {
  ...
  return (
    <div style={{ maxWidth: 680, margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 10, marginTop: 18 }}>
        {itens.map((it) => (
          <div key={it.id} className="ef-card" style={{ padding: 14, display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontFamily: "'Exo 2', sans-serif", fontSize: 13, color: it.disponivel ? "#fff" : "var(--muted)" }}>
                {it.nome}
              </div>
      ...
      <button onClick={addItem} className="ef-btn-outline" style={{ marginTop: 14, width: "100%", justifyContent: "center" }}>
