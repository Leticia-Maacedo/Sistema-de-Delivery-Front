...
import { Store, DollarSign, ClipboardList, Wallet, Star, Package } from "lucide-react";
    ...
    <div style={{ maxWidth: 960, margin: "0 auto", display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
        <div onClick={() => onGo("cardapios")} className="ef-card" style={{ padding: 18, cursor: "pointer" }}>
          ...
          <div style={{ fontFamily: "'Exo 2', sans-serif", fontWeight: 700, fontSize: 13, color: "#fff", marginTop: 10 }}>
            Gerenciar Cardápio
          </div>
          <div style={{ fontFamily: "'Exo 2', sans-serif", fontSize: 12, color: "var(--muted)", marginTop: 6 }}>
            Edite pratos, preços e disponibilidade.
          </div>
        </div>
        <div onClick={() => onGo("avaliacoes")} className="ef-card" style={{ padding: 18, cursor: "pointer" }}>
          ...
          <div style={{ fontFamily: "'Exo 2', sans-serif", fontSize: 12, color: "var(--muted)", marginTop: 6 }}>
            Veja e responda o feedback dos clientes.
          </div>
        </div>
      </div>
      ...
      <div className="ef-card" style={{ padding: 18 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8, marginTop: 12 }}>
          {meusPedidos.map((o) => (
            <div
              key={o.id}
              style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "10px 4px", borderTop: "1px solid var(--border)", fontFamily: "'Exo 2', sans-serif", fontSize: 13 }}
            >
