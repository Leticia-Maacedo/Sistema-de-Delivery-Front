        ...
        {REVIEWS.map((r) => (
          <div key={r.id} className="ef-card" style={{ padding: 16 }}>
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <span style={{ fontFamily: "'Exo 2', sans-serif", fontWeight: 600, fontSize: 13, color: "#fff" }}>{r.cliente}</span>
            ...
            {r.resposta ? (
              <div style={{ marginTop: 10, padding: 10, background: "var(--panel)", borderRadius: 8, borderLeft: "2px solid var(--accent)" }}>
                <span style={{ fontFamily: "'Exo 2', sans-serif", fontSize: 12, color: "var(--accent)" }}>Resposta: </span>
              ...
              <div style={{ display: "flex", gap: 8, marginTop: 10 }}>
                <input
                  ...
                  value={resp[r.id] || ""}
                  onChange={(e) => setResp({ ...resp, [r.id]: e.target.value })}
                />
